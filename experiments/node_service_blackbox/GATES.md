...
- [x] G1: Health check endpoint returns status ok
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T02:30:25.664706+00:00 match='HEALTH_PASS'

- [x] G2: Users resource supports CRUD operations
  CHECK: node test_service.js USERS
  EXPECT: USERS_PASS
  OWNS: src/routes/users.js, src/data/store.js
  EVIDENCE: exit_code=0 timestamp=2026-09-13T02:30:25.753046+00:00 match='USERS_PASS'
...
- [x] G3: Products catalog supports listing, fetching, and creating products
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T02:30:25.930086+00:00 match='PRODUCTS_PASS'
...
- [x] G4: Orders processing creates orders with validation
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T02:30:26.016137+00:00 match='ORDERS_PASS'

- [x] G5: Error handling returns proper HTTP error codes
  CHECK: node test_service.js ERRORS
  EXPECT: ERRORS_PASS
  OWNS: src/middleware/error.js
  EVIDENCE: exit_code=0 timestamp=2026-09-13T02:30:25.845635+00:00 match='ERRORS_PASS'
...
- [x] G6: End-to-end happy path creates user, product, and order in sequence
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T02:30:26.104003+00:00 match='E2E_PASS'
