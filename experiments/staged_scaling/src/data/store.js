 ...
 * Domain-agnostic — each repository instance manages one entity type.
 * Easily swappable for a database-backed implementation.
 */
class DataStore {
  constructor() {
    this._items = new Map();
  ...
  /** Create an item. Returns the created item with its id. */
  create(item) {
