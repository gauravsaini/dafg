...
- [x] G1: Project structure and package.json exist
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.322818+00:00 match='FILES_OK'
...
- [x] G2: All route modules exist
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.336058+00:00 match='ROUTES_OK'
...
- [x] G3: Integration test exists and is executable
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.349676+00:00 match='TEST_EXISTS'
...
- [x] G4: Health endpoint returns status ok
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.409086+00:00 match='PASSED:HEALTH'
...
- [x] G5: Users API — CRUD operations work
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.464428+00:00 match='PASSED:USERS'
...
- [x] G6: Products API — catalog operations work
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.521964+00:00 match='PASSED:PRODUCTS'
...
- [x] G7: Orders API — order processing works
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.579991+00:00 match='PASSED:ORDERS'
...
- [x] G8: Metrics API — request count, uptime, memory
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.635661+00:00 match='PASSED:METRICS'
...
- [x] G9: Error handling returns proper error responses
  ...
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.689542+00:00 match='PASSED:ERRORS'

- [x] G10: Full test suite passes
  CHECK: node test_service.js
  EXPECT: PASSED:HEALTH
  OWNS: experiments/blackbox_goal_organism/test_service.js
  EVIDENCE: exit_code=0 timestamp=2026-09-13T05:27:18.756177+00:00 match='PASSED:HEALTH'
