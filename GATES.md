...
- [x] G1: Offline test suite passes 100%
  ...
  EXPECT: 117 passed
  EVIDENCE: exit_code=0 timestamp=2026-09-11T05:22:26.700183+00:00 match='117 passed'

- [x] G2: Gate ledger linting reports clean
  CHECK: uv run gates --lint GATES.md
  EXPECT: Ledger lint passed: 0 issues found
  CWD: .
  EVIDENCE: exit_code=0 timestamp=2026-09-11T05:22:26.749608+00:00 match='Ledger lint passed: 0 issues found'
...
- [x] G3: Security approval boundary safely refuses unapproved checks
  ...
  CWD: .
  EVIDENCE: exit_code=0 timestamp=2026-09-11T05:22:26.797141+00:00 match='SECURITY_STATUS:UNAPPROVED'
...
- [x] G4: DAFG runtime enforces objective gate verification for node acceptance
  ...
  CWD: .
  EVIDENCE: exit_code=0 timestamp=2026-09-11T05:22:26.849343+00:00 match='NODE_STATUS:ACCEPTED'
...
- [x] G5: Stop hook blocks completion when pending gates exist
  ...
  CWD: .
  EVIDENCE: exit_code=0 timestamp=2026-09-11T05:22:26.896628+00:00 match='STOP_DECISION:block'
